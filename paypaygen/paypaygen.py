...
while cnt < 100:
 ...
 with open('paypays.txt', 'a') as paypays:
  print(f"https://pay.paypay.ne.jp/{code}", file=paypays)
  print(Underline + Bold + ColorRandom8 + f"Generated : https://pay.paypay.ne.jp/{code}" + Reset)
cnt += 1